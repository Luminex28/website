...
export function Hero() {
  ...
  return (
    <section className="hero section" id="home" ref={sectionRef}>
      ...
      <p className="eyebrow hero-item hero-status">
        {hero.eyebrow}
      </p>
      ...
      <div className="hero-grid">
        <div>
          <h1 className="hero-item hero-name">
            ...
            <br />
            <em>{profile.lastName.toUpperCase()}</em>
          </h1>

          <p className="hero-copy hero-item hero-copy-motion">
            {hero.sub}
          </p>
          ...
          <div className="actions hero-item hero-actions">
            ...
            <MagneticLink className="button" href="/contact">
              Get in touch <Arrow />
            </MagneticLink>
          </div>
        </div>
        ...
        <aside
          className="terminal hero-item hero-terminal"
